...
longtitle: "An overengineered BF language toolkit written in Go."
description: "an overengineered BF language toolkit written in Go."
index: 2
img: "/coverimgs/bfgo.webp"
---

import BFGOHeaders from "../../components/blogHeaders/BFGOHeaders.astro";
import NoPorM from "../../components/global/NoPorM.astro";

<BFGOHeaders {...frontmatter}>
  <NoPorM>
    <p> **Written in**: Go</p>
    <p>
      {" "}
      [See GitHub Repo](https://github.com/baris-inandi/brainfuck-go)
    </p>
  </NoPorM>
</BFGOHeaders>

> Brainf*ck is an esoteric programming language created in 1993 by Urban Müller. [(Wikipedia)](https://en.wikipedia.org/wiki/Brainfuck)
